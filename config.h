...
static const char *fonts[]          = { "proportional:size=12" };
...
static const char *dmenu_desktop_cmd[] = { "j4-dmenu-desktop", NULL };
static const char *passcmd[] = { "passmenu", NULL };

static const Key keys[] = {
	/* modifier                     key        function        argument */
	{ MODKEY,                       XK_p,      spawn,          {.v = dmenu_desktop_cmd } },
	{ MODKEY | ShiftMask,           XK_p,      spawn,          {.v = dmenucmd} },
	{ MODKEY | Mod1Mask,            XK_p,      spawn,          {.v = passcmd} },
